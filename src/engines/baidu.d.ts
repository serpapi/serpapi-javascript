...
export type BaiduParameters = BaseParameters & {
   ...
   * `stf=1672129104,1672733904|stftype=1` only returns results from the past 7 days.
   * First integer within the parameter,`1672129104` is Unix Timestamp for 7 days
   * ago. Second integer,`1672733904` is Unix Timestamp for now.).
   */
  gpc?: string;
